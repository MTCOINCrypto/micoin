...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Micoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"micointools.com", "52.15.214.235"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"micointools.com", "testnet-seed.micointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Micoin is probably already running."), addrBind.ToString().c_str());
        else
