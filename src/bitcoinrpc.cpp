...
{
    return GetBoolArg("-testnet", false) ? 36329 : 36327;
}
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use mtcoind";
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"Mtcoin Alert\" admin@foo.com\n"),
                strWhatAmI.c_str(),
